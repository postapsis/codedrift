...
Do the following, in order:
  ...
  4. THEN group the changed files into changesets. A changeset is a cohesive, self-contained unit of related change (one feature, refactor, fix, or concern). Give each a clear name and a description in markdown of what it groups and why. Every changed file belongs to exactly one changeset.
