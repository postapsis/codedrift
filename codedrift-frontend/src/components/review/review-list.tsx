  ...
  return (
    <ul className="flex flex-col gap-3">
      {reviews.map((review) => (
        <li
          key={review.id}
          className="flex items-start justify-between rounded-md border border-border gap-3 px-3 py-2 transition-colors hover:border-foreground/30 hover:bg-nav-active/20">
          <Link
